...
namespace GeneratorA
{
    class Program
    {
        ...
        {
            ParameterizedThreadStart pts1 = new ParameterizedThreadStart(FuelLevelSensorTask);
        ...
        static void FuelLevelSensorTask(object o)
        {
            Options options = (Options) o;
            using (FuelLevelSensor fs = new FuelLevelSensor(options.FuelSensorURI))
            {

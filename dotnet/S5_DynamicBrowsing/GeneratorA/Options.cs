...
namespace GeneratorA
{
    ...
    {
        [Option('f', "fuel_sensor_URI", Required = false, 
            Default = "file://./config/GeneratorA/FuelLevelSensorProperties.json", 
            HelpText = "fuel_sensor")]
        public string FuelSensorURI { get; set; } 
        [Option('s', "speed_sensor_URI", Required = false, 
            Default = "file://./config/GeneratorA/RotationalSpeedSensorProperties.json", 
            HelpText = "speed_sensor")]
        public string SpeedSensorURI { get; set; } 
        [Option('t', "temp_sensor_URI", Required = false, 
            Default = "file://./config/GeneratorA/TemperatureSensorProperties.json", 
            HelpText = "temp_sensor")]
        public string TempSensorURI { get; set; }               

...
set(DASH_COMMAND "${_base_dir}/${RUN_DASH}-prefix/src/${RUN_DASH}-build/start_dashboard${SHELL_EXT}")

foreach(_index RANGE 0 2)
  list(GET RUN_SENSORS ${_index} _gen)
  math(EXPR _sensor_no "${_index} + 1")
  set(SENSOR${_sensor_no}_COMMAND "${_base_dir}/${_gen}-prefix/src/${_gen}-build/start_sensor${SHELL_EXT}")
endforeach()

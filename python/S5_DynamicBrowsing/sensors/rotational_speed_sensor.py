...
class RotationalSpeedSensor(object):
    ...
    def create_thing(self):
        ...
        tgr.register_tag_groups_from_uri('file://definitions/TagGroup/com.adlinktech.example/RotationalSpeedTagGroup.json')
        self._datariver.add_tag_group_registry(tgr) 
  
        # Create and Populate the ThingClass registry with JSON resource files.
        tcr = JSonThingClassRegistry()
        tcr.register_thing_classes_from_uri('file://definitions/ThingClass/com.adlinktech.example/RotationalSpeedSensorThingClass.json')

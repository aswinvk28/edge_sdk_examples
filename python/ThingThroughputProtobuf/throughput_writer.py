...
class ThroughputWriter(object):
    ...
    def create_thing(self):
        ...
        tcr.register_thing_classes_from_uri('file://definitions/ThingClass/com.adlinktech.example.protobuf/ThroughputWriterThingClass.json')
    ...
    def setup_message(self, payload_size):
        ...
        self._sample.sequencenumber = 0
        self._sample.sequencedata = payload_size * b'a' 
    ...
    def wait_for_reader(self):
        try:
            ...
            while not reader_found:
                try:
                    thing = discovered_thing_registry.find_discovered_thing('*', 'ThroughputReader:com.adlinktech.example.protobuf:v1.0')
                    reader_found = True
                except:
        ...
        try:
            ...
            while not timed_out:
                ...
                if burst_count < burst_size:
                    burst_count += 1
                    self._sample.sequencenumber = count
                    count += 1

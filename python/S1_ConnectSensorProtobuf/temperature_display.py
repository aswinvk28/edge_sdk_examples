...
class TemperatureDisplay(object):
    ...
    def create_thing(self):
        ...
        tcr.register_thing_classes_from_uri(get_abs_file_uri('definitions/ThingClass/com.adlinktech.example.protobuf/TemperatureDisplayThingClass.json'))
            ...
            for msg in msgs:
                ...
                if flow_state == FlowState.ALIVE:
                    if msg.is_compatible(Temperature):
                        ...
                        print('Sensor data received: {:5.1f}'.format(sensor_data.temperature))

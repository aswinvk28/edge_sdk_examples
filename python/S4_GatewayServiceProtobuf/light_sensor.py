...
class LightSensor(object):
    ...
    def create_thing(self):
        ...
        tcr.register_thing_classes_from_uri(get_abs_file_uri('definitions/ThingClass/com.adlinktech.example.protobuf/LightSensorThingClass.json'))
    ...
    def write_sample(self, illuminance):
        ...
        sensor_data.illuminance = illuminance
        
        self._thing.write('illuminance', sensor_data)

    def alarm(self, message):
        alarm_data = IlluminanceAlarm()
        alarm_data.alarm = message

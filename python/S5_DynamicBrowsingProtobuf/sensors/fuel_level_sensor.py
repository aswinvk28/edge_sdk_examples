...
from definitions.FuelLevelTagGroup_pb2 import FuelLevel
from definitions.FuelLevelTagGroup_dr import FuelLevel_register_with_datariver
from definitions.SensorStateTagGroup_pb2 import SensorState
from definitions.SensorStateTagGroup_dr import SensorState_register_with_datariver
...
class FuelLevelSensor(object):
    ...
    def create_thing(self):
        ...
        FuelLevel_register_with_datariver(self._datariver)
        SensorState_register_with_datariver(self._datariver)
  
        # Create and Populate the ThingClass registry with JSON resource files.
        tcr = JSonThingClassRegistry()
        tcr.register_thing_classes_from_uri('file://definitions/ThingClass/com.adlinktech.example.protobuf/FuelLevelSensorThingClass.json')

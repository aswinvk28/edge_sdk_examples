...
class GatewayService(object):
    ...
    def create_thing(self):
        ...
        tcr.register_thing_classes_from_uri(get_abs_file_uri('definitions/ThingClass/com.adlinktech.example/GatewayServiceThingClass.json'))
    ...
    def run(self, running_time):
        ...
        while True:
            # Read data
            msgs = self._thing.read_next_iot_nvp('dynamicInput', int((running_time * 1000) - elapsed_time))
            ...
            for msg in msgs:
                ...
                sample_contains_data = (flow_state == FlowState.ALIVE) or (msg.data.size() > 0)

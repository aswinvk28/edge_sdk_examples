...
from adlinktech.datariver import IotValue, IotNvp, IotNvpSeq, ThingAPIException
...
class Camera(object):
    ...
    def create_thing(self):
        ...
        tgr.register_tag_groups_from_uri(get_abs_file_uri('definitions/TagGroup/com.adlinktech.example/CameraStateTagGroup.json'))
        tgr.register_tag_groups_from_uri(get_abs_file_uri('definitions/TagGroup/com.adlinktech.example/ObservationTagGroup.json'))
        self._datariver.add_tag_group_registry(tgr) 
 
        # Create and Populate the ThingClass registry with JSON resource files.
        tcr = JSonThingClassRegistry()
        tcr.register_thing_classes_from_uri(get_abs_file_uri('definitions/ThingClass/com.adlinktech.example/CameraThingClass.json'))

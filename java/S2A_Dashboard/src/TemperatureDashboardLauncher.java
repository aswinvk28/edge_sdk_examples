...
public class TemperatureDashboardLauncher {
	...
	public static void main(String[] args) {
        ...
        try {
            ...
            final Option filterOption = new Option("f", "filter", true, "Filter");
            ...
            final String filter = cmd.getOptionValue("f");
            final String thingPropertiesUri = cmd.getOptionValue("t");
            
            try(final TemperatureDashboard tempDashboard = new TemperatureDashboard(thingPropertiesUri)) {
                tempDashboard.run(filter, runningTime);
            }

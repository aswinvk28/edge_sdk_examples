...
public class GpsSensorLauncher {
    ...
    public static void main(String[] args) {
        ...
        try {
            ...
            final Option latOption = new Option("lat", "lat", true, "Truck start location latitude");
            latOption.setRequired(true);
            final Option lngOption = new Option("lng", "lng", true, "Truck start location longitude");
            ...
            final float truckLat = Float.parseFloat(cmd.getOptionValue("lat"));
            final float truckLng = Float.parseFloat(cmd.getOptionValue("lng"));
            final String thingPropertiesUri = cmd.getOptionValue("t");
            
            try(final GpsSensor gpsSensor = new GpsSensor(thingPropertiesUri, truckLat, truckLng)) {
                gpsSensor.run(runningTime);
            }

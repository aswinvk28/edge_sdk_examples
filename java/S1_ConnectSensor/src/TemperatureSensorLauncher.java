...
public class TemperatureSensorLauncher {
	public static void main(String[] args) {
        ...
        try {
            ...
            try(final TemperatureSensor temperatureSensor = new TemperatureSensor(thingPropertiesUri)) {
                temperatureSensor.run(runningTime);
            }
